    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="background: #0000; color: white">Home kas RT</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse" style="background: #770101; color: white">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?hal=produk"><i class="fa fa-book "></i> Warga</a></li>
                    <li><a href="index.php?hal=pembeli"><i class="fa fa-shopping-cart"></i> Iuran kas</a></li>
                    <!-- <li><a href="index.php?hal=laporan_pembelian"><i class="fa fa-file"></i> Laporan</a></li> -->
                    <li><a href="index.php?hal=pelanggan"><i class="fa fa-user"></i> Laporan</a></li>
